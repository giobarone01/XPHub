...
export default function HeroFeatured({ game }) {
    ...
    return (
        <motion.section
            ...
            className="container mx-auto mt-4 sm:mt-6 mb-10"
        >
            <div className="anim-border relative overflow-hidden rounded-2xl h-[360px] sm:h-[420px] md:h-[480px]">
                <img
                ...
                <motion.div
                    ...
                    initial="hidden"
                    animate="show"
                    className="relative z-10 flex h-full flex-col justify-end p-5 sm:p-8 md:p-12 max-w-2xl"
                >
                    <motion.span
                        variants={item}
                        className="mb-3 inline-flex w-fit items-center gap-1.5 rounded-full border border-my-cyan/40 bg-my-cyan/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-my-cyan"
                    >
                    ...
                    <motion.div
                        variants={item}
                        className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-gray-200"
                    >
                        {game.rating > 0 && (
